...
class stock_picking(osv.osv):
    ...
    def _get_invoice_vals(self, cr, uid, key, inv_type, journal_id, move, context=None):
        ...
        if move.purchase_line_id and move.purchase_line_id.order_id:
            ...
            inv_vals.update({
                'fiscal_position': purchase.fiscal_position.id if purchase.fiscal_position else purchase.partner_id.property_account_position.id,
                'payment_term': purchase.payment_term_id.id if purchase.payment_term_id else purchase.partner_id.property_supplier_payment_term.id,
                })
        return inv_vals
