...
class account_invoice_refund(osv.osv_memory):
    ...
    _columns = {
       ...
       'journal_id': fields.many2one('account.journal', 'Refund Journal', domain=_journal_domain, help='You can select here the journal to use for the credit note that will be created. If you leave that field empty, it will use the same journal as the current invoice.'),
