...
class hr_employee(osv.osv):
    ...
    def _calculate_total_wage(self, cr, uid, ids, name, args, context):
        ...
        for employee in self.browse(cr, uid, ids, context=context):
            if not employee.contract_ids:
                res[employee.id] = {'total_wage': 0.0}
                continue
            ...
            res[employee.id] = {'total_wage': result['sum']}
        return res
    ...
    _columns = {
        ...
        'total_wage': fields.function(_calculate_total_wage, method=True, multi="totals", type='float', string='Total Basic Salary', digits_compute=dp.get_precision('Payroll'), help="Sum of all current contract's wage of employee."),
