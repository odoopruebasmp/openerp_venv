...
class payment_order_create(osv.osv_memory):
    ...
    def search_entries(self, cr, uid, ids, context=None):
        ...
        domain = [('reconcile_id', '=', False), ('account_id.type', '=', 'payable'), ('credit', '>', 0),
                  ('account_id.reconcile', '=', True), ('amount_residual', '>', 0)]
        if data.partner_id:
        ...
        line_ids = line_obj.browse(cr, uid, line_obj.search(cr, uid, domain, context=context),
                                   context=context).filtered(lambda l: l.amount_residual > 0).ids
