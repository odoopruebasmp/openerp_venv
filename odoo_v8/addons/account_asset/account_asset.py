...
class account_asset_category(osv.osv):
    ...
    _columns = {
        ...
        'method': fields.selection([('linear', 'Linear'), ('reduction','Reducción de saldos')], 'Computation Method',
                                   required=True, help="Choose the method to use to compute the amount of "
                                    "depreciation lines.\n  * Linear: Calculated on basis of: Gross Value / Number of "
                                    "Depreciations\n  * Reducción de Saldos: Calculado según la Cuota de Salvamento, "
                                    "el Número de depreciaciones y el valor residual de la depreciación"),
    ...
    _columns = {
        ...
        'method': fields.selection([('linear', 'Linear'), ('reduction', 'Reducción de Saldos')], 'Computation Method',
                                   ...
                                   help="Choose the method to use to compute the amount of depreciation lines.\n"\
                                        ...
                                        "  * Reducción de Saldos: Calculado según la Cuota de Salvamento, el "
                                        "Número de depreciaciones y el valor residual de la depreciación"),
