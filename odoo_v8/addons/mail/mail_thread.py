...
class mail_thread(osv.AbstractModel):
    ...
    def write(self, cr, uid, ids, values, context=None):
        ...
        if tracked_fields:  # TODO mejoras en generacion posterior de mensajes
    ...
    def message_track(self, cr, uid, ids, tracked_fields, initial_values, context=None):
        ...
        for browse_record in self.browse(cr, uid, ids, context=context):
            ...
            force_mail = True if context.get('force_mail') else False
            ...
            if not posted:
                ...
                if force_mail:
                    self.message_post(cr, uid, browse_record.id, body=message, subtype='email', context=context)
                else:
    ...
    def message_route(self, cr, uid, message, message_dict, model=None, thread_id=None,
        ...
        #if not ref_match:
        #    ref_match = self.pool.get('mail.mail.statistics').search(cr, uid, [('message_id','=',thread_references)])
